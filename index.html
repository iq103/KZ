...
<body>
    <div class="container fade-in">
        ...
        <div class="btn-container">
            <button id="newPoemBtn">همسة جديدة <i class="heart fas fa-heart"></i></button>
        </div>
        
        <div class="special-message">
            إلى حبيبتي الغالية.. هذه القلوب تنبض باسمك، وهذه الكلمات تعجز عن وصف جمال روحك. 
            كل بيت شعر هنا يحمل نبض قلبي ولهفتي إليكِ. أحبكِ أكثر مما تستطيع الكلمات التعبير عنه.
        </div>
        
        <div class="footer">
            صنع بكل الحب <i class="heart fas fa-heart"></i> ليوم لا ننساه
        </div>
    </div>
